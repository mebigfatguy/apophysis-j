...
public class TwintrianVariation extends Variation
{
  @Override
public int getGroup()
  {
...
public void compute(XForm paramXForm)
  {
    ...
    double d4 = Math.log(d2 * d2) / Math.log(2.0D) + d3;

    paramXForm.fpx += this.weight * paramXForm.ftx * d4;
    paramXForm.fpy += this.weight * paramXForm.ftx * (d4 - d2 * 3.141592653589793D);
  }
}