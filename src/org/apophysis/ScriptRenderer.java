...
public class ScriptRenderer extends MyThinlet 
	implements Constants, ThreadTarget {
...
ScriptRenderer(String title, String xmlfile, int width, int height,
	Script script, JSRenderer jsrenderer)
	throws Exception
{
...
if(renderer.fstop==0)
	...
	try	{
		...
		renderer.saveImage(filename,
			jsrenderer.Comment,jsrenderer.Encrypted,jsrenderer.Watermark);
		}
	catch(Exception ex)
		{
		ex.printStackTrace();
