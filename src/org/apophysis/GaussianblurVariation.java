...
public String getName() { return "gaussian_blur"; }
...
double r = weight * (Math.random()+Math.random()+Math.random()+Math.random()-2);
xform.fpx += r*Math.cos(a);
xform.fpy += r*Math.sin(a);
}
