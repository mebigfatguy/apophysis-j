...
public class Export extends MyThinlet implements Constants {
    ...
    Export(String title, String xmlfile, int width, int height) throws Exception {
    ...
    void exportFlame() {
        ...
        try {
            ...
            try (PrintWriter w = new PrintWriter(new OutputStreamWriter(process.getOutputStream()))) {
                cp1.save(w);
            }
