...
String data = buildData(cp, boundary,
		Global.sheepNick, Global.sheepURL, Global.sheepPW);
...
if(id>0)
	Global.main.alert("Sheep succesfully posted to the server, id = "+id);

}	//	End of method	send

/******************************************************************************/

static String buildData(ControlPoint cp, String boundary,
	String nick, String url, String pw)
{
