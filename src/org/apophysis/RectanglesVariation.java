...
public String getName() { return "rectangles"; }
...
switch(index)
	{
	case 0: FX = value; break;
	case 1: FY = value; break;
	}
}
...
switch(context)
	{
	case 0:
		xform.fpx += weight*((2*Math.floor(xform.ftx/FX)+1)*FX-xform.ftx);
		xform.fpy += weight*((2*Math.floor(xform.fty/FY)+1)*FY-xform.fty);
		kount0++;
		break;
