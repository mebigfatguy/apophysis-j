...
SupershapeVariation()
{
pnames = new String[]{"super_shape_m","super_shape_n1","super_shape_n2",
	"super_shape_n3","super_shape_rnd","super_shape_holes"};
...
public String getName() { return "super_shape"; }
...
switch(index)
	...
	case 4: rnd = value; break;
	case 5: holes = value; break;
	}
}
...
if(n1==0)
	...
	r = (rnd*Math.random()+(1-rnd)*dist-holes)*Math.pow(t1+t2,-1.0/n1);
	}
