...
public String getName() { return "pdj"; }
...
switch(index)
	{
	case 0: fa = value; break;
	case 1: fb = value; break;
	case 2: fc = value; break;
	case 3: fd = value; break;
	}
}
...
{
xform.fpx += weight*(Math.sin(fa*xform.fty)-Math.cos(fb*xform.ftx));
xform.fpy += weight*(Math.sin(fc*xform.ftx)-Math.cos(fd*xform.fty));
}
