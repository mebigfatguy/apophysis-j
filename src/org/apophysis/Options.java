...
for(int i=0;i<nv;i++)
	svar[i] = new SortableVariation(
		XForm.getVariation(i).getName(),i,XForm.getVariation(i).getGroup());
...
setColor(find("btnBackgroundColor"),"background",
	new Color(Global.editorBkgColor));
setColor(find("btnReferenceColor"),"background",
	new Color(Global.referenceTriangleColor));
setColor(find("btnHelperColor"),"background",
	new Color(Global.helpersColor));
setColor(find("btnGridColor1"),"background",
	new Color(Global.gridColor1));
setColor(find("btnGridColor2"),"background",
	new Color(Global.gridColor2));
...
Global.randMinTransforms =
	Integer.parseInt(getString(find("udMinXForms"),"text"));
Global.randMaxTransforms =
	Integer.parseInt(getString(find("udMaxXForms"),"text"));

Global.mutantMinTransforms = 
	Integer.parseInt(getString(find("udMinMutate"),"text"));
Global.mutantMaxTransforms =
	Integer.parseInt(getString(find("udMaxMutate"),"text"));


Global.symmetryType = getInteger(find("cmbSymType"),"selected");
Global.symmetryOrder = 
	Integer.parseInt(getString(find("udSymOrder"),"text"));
Global.symmetryNVars = 
	Integer.parseInt(getString(find("udSymNVars"),"text"));

Global.batchSize = 
	Integer.parseInt(getString(find("udBatchSize"),"text"));

Global.randomPrefix = getString(find("txtRandomPrefix"),"text");

Global.defSampleDensity = 
	Double.valueOf(getString(find("txtSampleDensity"),"text")).doubleValue();
Global.defGamma = 
	Double.valueOf(getString(find("txtGamma"),"text")).doubleValue();
Global.defBrightness = 
	Double.valueOf(getString(find("txtBrightness"),"text")).doubleValue();
Global.defVibrancy = 
	Double.valueOf(getString(find("txtVibrancy"),"text")).doubleValue();
Global.defFilterRadius = 
	Double.valueOf(getString(find("txtFilterRadius"),"text")).doubleValue();

Global.defOversample = 
	Integer.parseInt(getString(find("txtOversample"),"text"));


Global.prevLowQuality = 
	Double.valueOf(getString(find("txtLowQuality"),"text")).doubleValue();
Global.prevMediumQuality = 
	Double.valueOf(getString(find("txtMediumQuality"),"text")).doubleValue();
Global.prevHighQuality = 
	Double.valueOf(getString(find("txtHighQuality"),"text")).doubleValue();


Global.editorBkgColor =
	getColor(find("btnBackgroundColor"),"background").getRGB();
Global.referenceTriangleColor = 
	getColor(find("btnReferenceColor"),"background").getRGB();
Global.helpersColor = 
	getColor(find("btnHelperColor"),"background").getRGB();
Global.gridColor1 = 
	getColor(find("btnGridColor1"),"background").getRGB();
Global.gridColor2 = 
	getColor(find("btnGridColor2"),"background").getRGB();
...
if(getInteger(find("cbNrThreads"),"selected")==0)
	...
	Global.nrThreads =
	Integer.parseInt(getString(find("cbNrThreads"),"text"));

Global.doubleClickSetVars = getBoolean(find("doubleclick1"),"selected");


Global.jpegQuality = 
	Integer.parseInt(getString(find("txtJPEGQuality"),"text"));
