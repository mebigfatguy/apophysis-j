...
filter_radius = Double.valueOf(getString(find("txtFilterRadius"),"text")).doubleValue();
sample_density = Double.valueOf(getString(find("txtDensity"),"text")).doubleValue();
...
preset.density =
	Double.valueOf(getString(find("txtDensity"),"text")).doubleValue();
preset.filter_radius = 
